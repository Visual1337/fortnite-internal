...
enum offsets : std::int32_t {
	bonematrix = 0x100FF3194,
	staticfindobject = 0xCF770C,
	processevent = 0xCE6100
};
...
public:
	...
	void process_event(uobject* function, void* args) {
		return reinterpret_cast<void (*)(uobject*, uobject*, void*, void*, void*)>(game + offsets::processevent)(this, function, args, nullptr, nullptr);
	}
